...
1. Clone this repo   
```git clone https://github.com/cesare-montresor/drl-continuous-control.git```

2. In the repo is provided a copy on the Reacher for OSX, in case you have a different OS, download the environment from one of the links below:
